...
import com.ecommerce.metier.Compte;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class Compte.
 * @see com.ecommerce.metier.Compte
...
public class CompteHome {
	...
	public Compte findById(java.lang.String id) {
		...
		try {
			Compte instance = (Compte) sessionFactory.getCurrentSession().get("com.ecommerce.dao.Compte", id);
			if (instance == null) {
	...
	public List<Compte> findByExample(Compte instance) {
		...
		try {
			List<Compte> results = (List<Compte>) sessionFactory.getCurrentSession()
					.createCriteria("com.ecommerce.dao.Compte").add(create(instance)).list();
