...
import com.ecommerce.metier.Adresse;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class Adresse.
 * @see com.ecommerce.metier.Adresse
...
public class AdresseHome {
	...
	public Adresse merge(Adresse detachedInstance) {
		...
		try {
			Adresse result = (Adresse) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Adresse findById(int id) {
		...
		try {
			Adresse instance = (Adresse) sessionFactory.getCurrentSession().get("com.ecommerce.dao.Adresse", id);
			if (instance == null) {
	...
	public List<Adresse> findByExample(Adresse instance) {
		...
		try {
			List<Adresse> results = (List<Adresse>) sessionFactory.getCurrentSession()
					.createCriteria("com.ecommerce.dao.Adresse").add(create(instance)).list();
