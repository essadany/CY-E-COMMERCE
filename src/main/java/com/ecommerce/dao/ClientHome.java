 ...
 * @see com.ecommerce.metier.Client
...
public class ClientHome {
	...
	public Client findById(int id) {
		...
		try {
			Client instance = (Client) sessionFactory.getCurrentSession().get("com.ecommerce.dao.Client", id);
			if (instance == null) {
	...
	public List<Client> findByExample(Client instance) {
		...
		try {
			List<Client> results = (List<Client>) sessionFactory.getCurrentSession()
					.createCriteria("com.ecommerce.dao.Client").add(create(instance)).list();
